...
**⚠️ По причине опасения кражи исходного кода было решено отказаться от его полной публикации в репозитории. Вместо этого были размещены только его части.**

Части кода распололожены в каталоге [```src```](https://github.com/MOI-razrabotki/CheckMate/tree/main/src)
